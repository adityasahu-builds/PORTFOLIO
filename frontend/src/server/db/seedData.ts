export const defaultPersonalInfo = {
  ...
  socialLinks: {
    ...
    portfolio: "https://adityasahubuilds.dev",
    resume: "",
    twitter: "",
...
export const defaultProjects = [
  {
    ...
    shortDescription:
      "AI-powered resume analysis platform that analyzes CVs, evaluates ATS compatibility, identifies improvement areas, and helps users improve their resumes.",
    longDescription:
      "Comprehensive Next.js resume analyzer powered by Gemini and Groq AI inference, scanning resumes for ATS formatting compliance, missing skills, and scoring strengths.",
    techStack: ["Next.js", "TypeScript", "React", "Tailwind CSS", "Express", "Gemini", "Groq"],
    technologies: ["Next.js", "TypeScript", "React", "Tailwind CSS", "Express", "Gemini", "Groq"],
  ...
  },
  {
    ...
    shortDescription:
      "A personal AI assistant combining custom natural-language understanding, voice interaction and AI-powered task processing.",
    longDescription:
      "Flutter and Dart cross-platform AI assistant integrating Whisper speech-to-text, Gemini multi-modal reasoning, and custom local intent classification.",
    techStack: ["Flutter", "Dart", "Groq", "Gemini", "Whisper", "Custom NLU"],
    technologies: ["Flutter", "Dart", "Groq", "Gemini", "Whisper", "Custom NLU"],
    gitHubUrl: "https://github.com/adityasahu-builds",
    githubUrl: "https://github.com/adityasahu-builds",
    liveUrl: "",
    thumbnail: "/projects/ultron.png",
  ...
  },
  {
    ...
    shortDescription:
      "An intelligent disaster-management platform designed for environmental monitoring, situational awareness and disaster-response support.",
    longDescription:
      "Next.js disaster telemetry and monitoring system integrating maps, meteorological telemetry streams, and emergency situational awareness dashboards.",
    techStack: ["Next.js", "TypeScript", "APIs", "Maps", "Weather/Telemetry data"],
    technologies: ["Next.js", "TypeScript", "APIs", "Maps", "Weather/Telemetry data"],
    gitHubUrl: "https://github.com/adityasahu-builds",
    githubUrl: "https://github.com/adityasahu-builds",
    liveUrl: "",
    thumbnail: "/projects/aeris.jpg",
