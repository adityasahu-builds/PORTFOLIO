        ...
        >
          ...
          <div className="w-full lg:w-1/2 flex flex-col gap-8">
            ...
            <div className="flex flex-wrap gap-4 mt-4">
              ...
              >
                <span>GitHub</span>
                <svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4 group-hover:translate-x-0.5 group-hover:-translate-y-0.5 transition-transform" aria-hidden="true">
