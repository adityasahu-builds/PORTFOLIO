...
export function Hero() {
  ...
  return (
    ...
    >
      ...
      {/* ─── MAIN HERO CONTENT ─────────────────────── */}
      <div
        className="relative z-10 w-full max-w-[1440px] mx-auto px-5 sm:px-6 md:px-8 grid grid-cols-[0.95fr_1.05fr] lg:grid-cols-[1fr_auto_1fr] items-center gap-x-3 gap-y-8 xs:gap-y-10 sm:gap-6 lg:gap-8 pt-[76px] lg:pt-0"
      >
        {/* ── LEFT: Text Content ──────────────────── */}
        <motion.div
          ...
          className="order-1 lg:order-1 flex flex-col gap-0 z-10 w-full max-w-[520px] mx-auto lg:mx-0 text-left items-start pl-7 sm:pl-0 lg:translate-x-[60px]"
        >
          {/* Hi, I'm */}
          <motion.p
