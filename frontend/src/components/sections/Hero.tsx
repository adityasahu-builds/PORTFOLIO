...
export function Hero() {
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 w-full max-w-[1600px] mx-auto px-4 sm:px-8 md:px-10 lg:px-12 flex-1 flex flex-col justify-end lg:justify-center pt-[clamp(20rem,50vh,30rem)] lg:pt-0 pb-0">
      ...
      {/* ── Scroll Indicator ── */}
      <div className="relative z-10 w-full flex flex-col items-center mt-6 sm:mt-8 pb-5 sm:pb-6 px-4">
