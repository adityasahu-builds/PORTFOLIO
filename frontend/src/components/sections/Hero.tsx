...
export function Hero() {
  ...
  return (
    ...
    >
      ...
      {/* ─── MAIN HERO CONTENT ─────────────────────── */}
      <div
        className="relative z-10 w-full max-w-[1440px] mx-auto px-5 sm:px-6 md:px-8 grid grid-cols-[40%_60%] lg:grid-cols-[1fr_auto_1fr] items-center gap-x-1 gap-y-8 xs:gap-y-10 sm:gap-6 lg:gap-8 pt-[76px] lg:pt-0"
      >
        {/* ── LEFT: Text Content ──────────────────── */}
        <motion.div
        ...
        <motion.div
          ...
          className="order-2 lg:order-2 relative z-10 mx-auto lg:mx-0 flex items-center justify-center pointer-events-auto lg:translate-x-[45px] w-full max-w-[320px] xs:max-w-[340px] sm:max-w-[380px] md:max-w-[420px] lg:w-[clamp(420px,42vw,570px)] aspect-[13/16] lg:aspect-auto lg:h-[clamp(570px,72vh,780px)] mt-2 lg:mt-0"
        >
