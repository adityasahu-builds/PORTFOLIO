...
export function Hero() {
  ...
  return (
    ...
    >
      ...
      {/* ─── MAIN HERO CONTENT ─────────────────────── */}
      <div
        className="relative z-10 w-full max-w-[1440px] mx-auto px-5 sm:px-6 md:px-8 grid grid-cols-[40%_60%] md:grid-cols-[1fr_auto_1fr] items-center gap-x-1 gap-y-8 xs:gap-y-10 sm:gap-6 md:gap-8 pt-[76px] md:pt-0"
      >
        {/* ── LEFT: Text Content ──────────────────── */}
        <motion.div
          ...
          className="order-1 md:order-1 flex flex-col gap-0 z-10 w-full max-w-[520px] mx-auto md:mx-0 text-left items-start pl-6 sm:pl-0 md:translate-x-[60px]"
        >
          {/* Hi, I'm */}
          <motion.p
        ...
        <div
          className="order-3 col-span-2 md:col-span-1 flex flex-col sm:grid sm:grid-cols-2 md:flex md:flex-col gap-3 md:gap-[0.9rem] z-10 items-center md:items-end w-full max-w-[320px] sm:max-w-[500px] mx-auto md:max-w-none md:mx-0 md:translate-x-[50px] pb-24 md:pb-0"
        >
          {(() => {
