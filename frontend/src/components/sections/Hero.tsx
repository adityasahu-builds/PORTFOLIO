...
export function Hero() {
  ...
  return (
    ...
    >
      ...
      {/* ─── MAIN HERO CONTENT ─────────────────────── */}
      <div
        className="relative z-10 w-full max-w-[1440px] mx-auto px-5 sm:px-6 md:px-8 grid grid-cols-[0.95fr_1.05fr] lg:grid-cols-[1fr_auto_1fr] items-center gap-4 sm:gap-6 lg:gap-8 pt-[72px] lg:pt-0"
      >
        {/* ── LEFT: Text Content ──────────────────── */}
        <motion.div
          ...
          className="order-1 lg:order-1 flex flex-col gap-0 z-10 w-full max-w-[520px] mx-auto lg:mx-0 text-left items-start pl-7 sm:pl-0 -translate-y-8 lg:translate-y-0 lg:translate-x-[60px]"
        >
          {/* Hi, I'm */}
          <motion.p
        ...
        <motion.div
          ...
          className="order-2 lg:order-2 relative z-10 mx-auto lg:mx-0 flex items-center justify-center pointer-events-auto lg:translate-x-[45px] w-full max-w-[190px] xs:max-w-[220px] sm:max-w-[280px] md:max-w-[340px] lg:w-[clamp(420px,42vw,570px)] aspect-[13/16] lg:aspect-auto lg:h-[clamp(570px,72vh,780px)] mt-0 lg:mt-0 -translate-y-8 lg:translate-y-0"
        >
