...
export function HeroContent({
  ...
  // Fetch dynamic personal information from API (saved from admin panel)
  ...
  const githubUrl = personalInfo?.socialLinks?.github || "https://github.com/adityasahu";
  const linkedinUrl = personalInfo?.socialLinks?.linkedin || "https://linkedin.com/in/adityasahu";
  const instagramUrl = personalInfo?.socialLinks?.instagram || "https://instagram.com/adityasahu";
  const emailRaw = personalInfo?.contact?.primaryEmail || personalInfo?.email || "hello@adityasahu.dev";
  const emailUrl = emailRaw.startsWith("mailto:") ? emailRaw : `mailto:${emailRaw}`;
